<!--
  ...
  Placeholders are filled by scripts/render_readme.py:
    {{YEARS}} {{COMMITS}} {{ISSUES}} {{PRS}} {{STARS}} {{REPOS}}
    {{CONTRIBUTED}} {{STREAK}} {{UPDATED}}
-->
...
I joined GitHub {{YEARS}} and have since pushed **{{COMMITS}}** commits, opened
**{{ISSUES}}** issues, and submitted **{{PRS}}** pull requests. My **{{REPOS}}**
public projects have earned **{{STARS}}** stars, and I've contributed to
**{{CONTRIBUTED}}** repositories I don't own.

Current commit streak: **{{STREAK}}**.
